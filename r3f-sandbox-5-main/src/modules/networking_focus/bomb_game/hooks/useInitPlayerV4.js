 ...
 * Uses separate group name "bombGamePlayerMovement" to avoid conflicts.
 */
export function useInitPlayerV4(group = "bombGamePlayerMovement", areaSize = 5) {
  ...
  useEffect(() => {
    ...
    hasInitialized.current = true;
    console.log(`[Bomb Game] Initialized local player ${peerId} at`, spawn);

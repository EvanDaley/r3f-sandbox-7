import { useInitPlayerV4 } from "./hooks/useInitPlayerV4";
...
import { useRobotMovementV4 } from "./hooks/useRobotMovementV4";
...
export default function MoveablePlayersV4({ onLocalPlayerRef }) {
  useInitPlayerV4();

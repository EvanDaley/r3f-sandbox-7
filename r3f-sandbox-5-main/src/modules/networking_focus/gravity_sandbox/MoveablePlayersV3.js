import { useInitPlayerV3 } from "./hooks/useInitPlayerV3";
...
import { useRobotMovementV3 } from "./hooks/useRobotMovementV3";
...
export default function MoveablePlayersV3({ onLocalPlayerRef }) {
  useInitPlayerV3();

 ...
 * Uses separate group name "activityPlayerMovement" to avoid conflicts.
 */
export function useInitPlayerV2(group = "activityPlayerMovement", areaSize = 5) {
  ...
  useEffect(() => {
    ...
    hasInitialized.current = true;
    console.log(`[Activity Sandbox] Initialized local player ${peerId} at`, spawn);
